...
app.controller("myCtr", function ($scope, $http) {
    ...
    .then(function (response) {        
        ...
        let qrCodeText = `Registration No = ${response.data.registrationNo}, Name = ${response.data.nametitle} ${response.data.name}, Contact No = ${response.data.contactno}, Identification Mark = ${response.data.mark} `;
    ...
    $scope.back = () => {
        window.location.href = "http://localhost:1000/user/trackApplicationForOneYear"
    }
});